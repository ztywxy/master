...
class BaseDecoder(LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument(
            '--train_file', default="/home/teddy/nlp/knowledge-probing-private-tianyi/data/training_data/PAQ/paq_train.tsv")   #data/training_data/wikitext-2-raw/wiki.train.raw
        parser.add_argument(
            '--valid_file', default="/home/teddy/nlp/knowledge-probing-private-tianyi/data/training_data/PAQ/paq_valid.tsv")
        parser.add_argument(
            '--test_file', default="/home/teddy/nlp/knowledge-probing-private-tianyi/data/training_data/PAQ/paq_test.tsv")
